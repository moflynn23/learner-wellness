"""
Django settings for learner_wellness project.
...
ROOT_URLCONF = 'learner_wellness.urls'
...
WSGI_APPLICATION = 'learner_wellness.wsgi.application'
...
ACCOUNT_EMAIL_VERIFICATION = 'none' #skip having to verify email account when signup
